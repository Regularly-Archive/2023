...
namespace EdgeTTSSharp
{
    public class Communicate
    {
        ...
        public Communicate(VoicesManager.Voice voice, int rate = 0, int volume = 0, int pitch = 0)
        {
            _voice = voice.Name;
            _rate = FormatVoiceParameter(rate, "%");
            _volume = FormatVoiceParameter(volume, "%");
            _pitch = FormatVoiceParameter(pitch, "Hz");
            _text = "长太息以掩涕兮，哀民生之多艰。\r\n\r\n余虽好修姱以鞿羁兮，謇朝谇而夕替。\r\n\r\n既替余以蕙纕兮，又申之以揽茝。\r\n\r\n亦余心之所善兮，虽九死其犹未悔。\r\n\r\n怨灵修之浩荡兮，终不察夫民心。\r\n\r\n众女嫉余之蛾眉兮，谣诼谓余以善淫。\r\n\r\n固时俗之工巧兮，偭规矩而改错。\r\n\r\n背绳墨以追曲兮，竞周容以为度。\r\n\r\n忳郁邑余侘傺兮，吾独穷困乎此时也。\r\n\r\n宁溘死以流亡兮，余不忍为此态也。";
        }
        ...
        private string FormatVoiceParameter(int value, string unit)
        {
