(function (factory) {
  ...
  (function (require$$1, stream, require$$1$1, require$$3, require$$4, require$$0$1, require$$6, require$$4$2, require$$0$2, require$$4$1, zlib, EventEmitter) {
    ...
    var populate$1 = function populate$1(dst, src) {
    ...
    utils.reduceDescriptors(AxiosHeaders.prototype, function (_ref9, key) {
    ...
    var textEncoder = new require$$1.TextEncoder();
    var CRLF = '\r\n';
    ...
    var formDataToStream = function formDataToStream(form, headersHandler, options) {
      var _ref10 = options || {},
        ...
        boundary = _ref10$boundary === void 0 ? tag + '-' + utils.generateString(size, BOUNDARY_ALPHABET) : _ref10$boundary;
    ...
    var ZlibHeaderTransformStream = /*#__PURE__*/function (_stream$Transform2) {
      _inherits(ZlibHeaderTransformStream, _stream$Transform2);
          ...
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              ...
              case 40:
                ...
                _context4.prev = 43;
                _context4.next = 46;
                return require$$1.promisify(data.getLength).call(data);
              case 46:
    ...
    var adapters = {
      getAdapter: function getAdapter(adapters) {
        ...
        if (!adapter) {
          var reasons = Object.entries(rejectedReasons).map(function (_ref14) {
    ...
    Object.entries(HttpStatusCode).forEach(function (_ref16) {
    ...
    var list_voices = function list_voices() {
      ...
      axios$1.get(options).then(function (res) {
        return res;
    ...
    var VoicesManager = /*#__PURE__*/function () {
      function VoicesManager() {
        _classCallCheck$1(this, VoicesManager);
      }
      _createClass$1(VoicesManager, null, [{
        key: "create",
        value: function create() {
          var voiceManager = new VoiceManager();
          voiceManager.voices = list_voices();
          var _iterator = _createForOfIteratorHelper$1(voiceManager.voices),
            _step;
          try {
    ...
    return index;
  })(require$$1, stream, require$$1$1, require$$3, require$$4, require$$0$1, require$$6, require$$4$2, require$$0$2, require$$4$1, zlib, EventEmitter);
